...
def handle_dialog(req, res):
    ...
    if req['session']['message_id']==1:
        ...
        res['response']['text'] = 'Приятно познакомиться, ' +first_name.title() + '. Я - Алиса. Какой сайт хочешь сделать?'
        res['response']['buttons'] = get_suggests()
        return
    if req['request']['original_utterance'].lower() == 'Хочу лэндинг!':
...
def get_suggests():
    ...
    arr = ['Хочу лэндинг!','стоп'] + session['suggests']
    suggests = [
