...
def bye(city):
    ...
    url = "https://search-maps.yandex.ru/v1/?apikey=9ec008c8-1b5b-4ca5-897a-0f18ecb866d0&text=Разработка сайтов&type=biz&ll="+coord+"&spn=0.08,0.08&lang=ru_RU&results=3"
